...
let tests =
  testList "Domain" [
    ...
    testCase "named accessors resolve to the atlas positions" (fun () ->
      ...
      Expect.equal Tiles.tankTurretGreen.Name "tank_turret_green" "turret green"
      Expect.equal Tiles.tankTurretBeige.Name "tank_turret_beige" "turret beige"
    ...
    testCase "named turret and enemy accessors are wired" (fun () ->
      ...
      Expect.equal Tiles.turretMissilesDual.Name "turret_missiles_dual" "missiles"
